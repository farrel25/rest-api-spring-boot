 ...
 * by extending CrudRepository interface to this interface
 * this interface will automatically have ability to proccess basic CRUD without explicitly code inside this interface
